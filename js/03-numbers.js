...
// parseInt - запинается на первом не числе, метод не деструктивный не изминяет то что вы туда передаете
...
// интерпритатор читает из глубины, сначала самое вложенное делает, а потом самое внешнее
...
/*
 * Генерим псевдослучайные числа от 0 до 1
 * - Math.random()
 * - Math.round()
 */
