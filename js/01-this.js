...
// // в обьект user в свойство showUserTag я записываю ссылку на ф-цию showTag
...
//     // метод это просто ф-ция, которая лежитв свойтве showTag
//     showTag() {
//         console.log('showTag -> this', this);
//         console.log('showTag -> this.tag', this.tag);
//     },
...
// // важ как ф-ция вызвалась
// user.showTag(); 

// // в переменную outerShowTag записывается ссылка на ф-цию showTag
// const outerShowTag = user.showTag;

// outerShowTag();

// в user нет метода outerShowTag => undefined()
// user.outerShowTag()
...
//     // важно кто вызвал, что слева? 
//     action();
// };

// // передаем аргументом ссылку на ф-цию showTag
...
// [C:\Users\Admin\Documents\GitHub\js-repetition\images\swapColor.png]
